...
(`io.github.A1-x-Tech/mcp-google-gmail`). Check before publishing — all three must
...
2. Point it at `https://github.com/A1-x-Tech/mcp-google-gmail`. LobeHub pulls the README,
   tool list and install config (`npx -y mcp-google-gmail`) automatically.
